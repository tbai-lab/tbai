...
constexpr int ANYMAL_D_NUM_JOINTS = 12;
constexpr int ANYMAL_D_STATE_DIM = 3 + 3 + 3 + 3 + ANYMAL_D_NUM_JOINTS + ANYMAL_D_NUM_JOINTS;

struct AnymalDRobotInterfaceArgs {
...
class AnymalDRobotInterface : public RobotInterface {
   public:
    AnymalDRobotInterface(AnymalDRobotInterfaceArgs args);
    virtual ~AnymalDRobotInterface();
