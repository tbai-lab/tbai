...
constexpr int BEYOND_OBS_JOINT_VEL_REL = 29;
constexpr int BEYOND_OBS_LAST_ACTION = 29;
constexpr int BEYOND_TOTAL_OBS_SIZE = BEYOND_OBS_MOTION_CMD + BEYOND_OBS_ANCHOR_ORI + BEYOND_OBS_BASE_ANG_VEL +
                                      BEYOND_OBS_JOINT_POS_REL + BEYOND_OBS_JOINT_VEL_REL + BEYOND_OBS_LAST_ACTION;

constexpr int BEYOND_NUM_BODIES = 14;
...
class G1BeyondMimicController : public tbai::Controller {
   ...
   protected:
    ...
    Eigen::Matrix<scalar_t, BEYOND_NUM_BODIES, 3> motionBodyPos_;
    Eigen::Matrix<scalar_t, BEYOND_NUM_BODIES, 4> motionBodyQuat_;  // wxyz format
