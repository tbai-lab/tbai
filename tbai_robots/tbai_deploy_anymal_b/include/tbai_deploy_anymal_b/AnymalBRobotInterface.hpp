...
#define ANYMAL_B_TOPIC_LOWCMD "rt/lowcmd"
#define ANYMAL_B_TOPIC_LOWSTATE "rt/lowstate"

namespace tbai {

constexpr int ANYMAL_B_NUM_JOINTS = 12;
constexpr int ANYMAL_B_STATE_DIM = 3 + 3 + 3 + 3 + ANYMAL_B_NUM_JOINTS + ANYMAL_B_NUM_JOINTS;

struct AnymalBRobotInterfaceArgs {
...
class AnymalBRobotInterface : public RobotInterface {
   public:
    AnymalBRobotInterface(AnymalBRobotInterfaceArgs args);
    virtual ~AnymalBRobotInterface();
